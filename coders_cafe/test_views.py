...
class TestBookingViews(TestCase):
    ...
    def setUp(self):
        ...
        self.booking = Booking(id=1,user=self.user, date=self.tomorrow, start_time=8, num_seats=2)
        self.booking.save()
    ...
    def test_unsuccessful_booking_creation(self):
        ...
        response = self.client.post(reverse('create_booking'), data=booking_data)
