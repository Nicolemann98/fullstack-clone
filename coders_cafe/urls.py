...
urlpatterns = [
    ...
    path('bookings/delete-booking/<int:booking_id>', views.delete_booking, name='delete_booking'),
    # path('bookings/delete-booking/success', views.BookingList.as_view(), name='delete_booking_success'),
]
